...
scoreboard objectives add meteors.rotation.left dummy
scoreboard objectives add meteors.rotation.right dummy

scoreboard objectives add meteors.const dummy
scoreboard players set 1 meteors.const 1
scoreboard players set 2 meteors.const 2
scoreboard players set 4 meteors.const 4
